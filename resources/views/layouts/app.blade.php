        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    <h6>Kategori</h6>
                    <ul class="list-unstyled">
                        <li><a href="{{ url('/shop?cat=running') }}" class="text-muted text-decoration-none small">Running Shoes</a></li>
                        <li><a href="{{ url('/shop?cat=trail') }}" class="text-muted text-decoration-none small">Trail Run</a></li>
                        <li><a href="{{ url('/shop?cat=apparel') }}" class="text-muted text-decoration-none small">Apparel</a></li>
                    </ul>
                </div>
                <div class="col-md-3 mb-4">
                    <h6>Follow Us</h6>
            ...
            <div class="text-center">
                <p class="mb-0 text-muted small">© 2026 RUNORA — Red. White. Black. Run with spirit.</p>
            </div>
        </div>
    </footer>
